...
class HttpServer {
  ...
  private defineRoutes() {
    ...
    this.apiV1Router.post('/project/', authManager.assertRoles(Role.LEVEL_1), inputValidator.validateModel(TableName.PROJECTS), createRecord(TableName.PROJECTS));
    this.apiV1Router.post('/project/:id', authManager.assertRoles(Role.LEVEL_1), inputValidator.validateModel(TableName.PROJECTS), updateRecord(TableName.PROJECTS));
