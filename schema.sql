...
CREATE TABLE `weekly_payroll_histories` (
  ...
  `hours_day_1` int NOT NULL,
  `hours_day_2` int NOT NULL,
  `hours_day_3` int NOT NULL,
  `hours_day_4` int NOT NULL,
  `hours_day_5` int NOT NULL,
  `hours_day_6` int NOT NULL,
  `hours_day_7` int NOT NULL,
  `slip_regular_hours` int NOT NULL,
  `slip_overtime_hours` int NOT NULL,
  `slip_addition_1` int NOT NULL,
  `slip_addition_2` int NOT NULL,
  `slip_addition_3` int NOT NULL,
  `slip_deduction_1` int NOT NULL,
  `slip_deduction_2` int NOT NULL,
  `slip_deduction_3` int NOT NULL,
  `slip_deduction_4` int NOT NULL,
  `slip_deduction_5` int NOT NULL,
  `slip_deduction_6` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `project_id` (`project_id`),
  KEY `employee_id` (`employee_id`),
